...
#define PM_QOS_DEVICE_FREQ_MAX_DEFAULT_VALUE	560000
#define PM_QOS_BUS_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_BUS_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_BUS_FREQ_MAX_DEFAULT_VALUE	1552000
#define PM_QOS_DISPLAY_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_DISPLAY_FREQ_MAX_DEFAULT_VALUE	267000
#define PM_QOS_CAM_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_CAM_FREQ_MAX_DEFAULT_VALUE	540000
