...
static unsigned int int_freq =  560000;
static unsigned int disp_freq = 267000;
static unsigned int isp_freq =  540000;
struct thermal_cooling_device *cool_dev;
extern struct kobject *power_kobj;
DEFINE_MUTEX(qos_table_lock);

struct thermal_qos {
        unsigned int cluster0_num;
        unsigned int cluster1_num;
 ...
 /*cluster0_num, cluster1_num, cpu_freq, kfc_freq, power, perf*/
static struct thermal_qos qos_table[] = {
        {4, 4, 2100000, 1500000, 852, 1552000, 1215, 37110},
        {4, 3, 2100000, 1500000, 852, 1552000, 1143, 31110},
        {4, 4, 1800000, 1500000, 852, 1552000, 1126, 36360},
        {4, 3, 1800000, 1500000, 852, 1552000, 999, 30060},
        {4, 2, 2100000, 1500000, 852, 1552000, 969, 24670},
        {4, 4, 1600000, 1500000, 852, 1552000, 924, 33560},
        {4, 2, 1800000, 1500000, 852, 1552000, 845, 23760},
        {4, 3, 1600000, 1500000, 852, 1552000, 825, 27960},
        {4, 1, 2100000, 1500000, 852, 1552000, 811, 18160},
        {4, 4, 1400000, 1500000, 852, 1552000, 804, 30760},
        {4, 2, 1600000, 1500000, 852, 1552000, 750, 22360},
        {4, 3, 1400000, 1500000, 852, 1552000, 730, 25860},
        {4, 4, 1200000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1800000, 1500000, 852, 1552000, 700, 17460},
        {4, 2, 1400000, 1500000, 852, 1552000, 658, 20960},
        {4, 3, 1200000, 1500000, 852, 1552000, 637, 23760},
        {4, 1, 1600000, 1500000, 852, 1552000, 631, 16760},
        {4, 4, 1000000, 1500000, 544, 1552000, 619, 25160},
        {4, 2, 1200000, 1500000, 544, 1552000, 605, 19560},
        {4, 3, 1000000, 1500000, 544, 1552000, 583, 21660},
        {4, 1, 1400000, 1500000, 544, 1552000, 530, 16760},
        {4, 2, 1000000, 1500000, 544, 1552000, 524, 18160},
        {4, 1, 1200000, 1500000, 544, 1552000, 501, 15360},
        {4, 1, 1000000, 1500000, 544, 1552000, 469, 14660},
        {4, 1, 1000000, 1400000, 544, 1552000, 468, 14650},
        {4, 1, 1000000, 1200000, 544, 1552000, 466, 14645},
        {3, 1, 1000000, 1400000, 544, 1552000, 465, 14644},
        {4, 1, 1000000, 1000000, 544, 1552000, 464, 14642},
        {3, 1, 1000000, 1200000, 544, 1552000, 463, 14641},
        {3, 1, 1000000, 1000000, 544, 1552000, 462, 14640},
        {4, 0, 2100000, 1500000, 544, 632000, 302, 11160},
        {4, 0, 2100000, 1500000, 420, 543000, 261, 10460},
        {4, 0, 2100000, 1400000, 420, 543000, 260,  9672},
        {4, 0, 2100000, 1400000, 420, 543000, 252,  7812},
        {4, 0, 2100000, 1400000, 420, 543000, 251,  7811},
};

/* NOTE: Should have the same size as qos_table */
static struct thermal_qos benchmark_qos_table[] = {
        {4, 4, 2100000, 1500000, 852, 1552000, 1215, 37110},
        {4, 4, 1896000, 1500000, 852, 1552000, 1126, 36360},
        {4, 4, 1800000, 1500000, 852, 1552000, 924, 33560},
        {4, 4, 1704000, 1500000, 852, 1552000, 924, 33560},
        {4, 4, 1600000, 1500000, 852, 1552000, 924, 33560},
        {4, 4, 1500000, 1500000, 852, 1552000, 924, 33560},
        {4, 4, 1400000, 1500000, 852, 1552000, 924, 33560},
        {4, 4, 1300000, 1500000, 852, 1552000, 924, 33560},
        {4, 3, 2100000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1896000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1800000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1704000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1600000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1500000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1400000, 1500000, 852, 1552000, 825, 27960},
        {4, 3, 1300000, 1500000, 852, 1552000, 825, 27960},
        {4, 2, 2100000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1896000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1800000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1704000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1600000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1500000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1400000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1300000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1200000, 1500000, 852, 1552000, 701, 27960},
        {4, 2, 1100000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1800000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1704000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1600000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1500000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1400000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1200000, 1500000, 852, 1552000, 701, 27960},
        {4, 1, 1000000, 1500000, 852, 1552000, 701, 27960},
        {4, 1,  800000, 1500000, 852, 1552000, 701, 27960},
        {4, 0, 2100000, 1500000, 852, 1552000, 701, 27960},
};
...
static struct attribute_group attr_group = {
 ...
 /*cluster0_qos cluster1_qos, gpu_qos, mif_qos, int_qos, disp_qos, isp_qos,cpu_qos, kfc_qos*/
	...
	struct thermal_qos *g_qos_table = qos_table_list[g_power_mode];
		...
		if (g_qos_table != benchmark_qos_table) {
			for (j = i; j <= QOS_MAX_STATE; j++) {
                ...
                request_thermal_power_mode(g_qos_table[i].cluster1_freq,
                                           g_qos_table[i].cluster0_freq,
                                           g_qos_table[i].gpu_freq,
                                           g_qos_table[i].mif_freq,
                                           int_freq, disp_freq, isp_freq,
                                           g_qos_table[i].cluster0_num,
                                           g_qos_table[i].cluster1_num);
        }
